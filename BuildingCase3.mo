model BuildingCase3
  ...
  Modelica.Mechanics.MultiBody.Sensors.AbsoluteSensor SprungMassCase3(get_a = true, get_r = true, get_v = true) annotation(
  ...
  Modelica.Mechanics.MultiBody.Sensors.AbsoluteSensor UnsprungMassCase3(get_a = true, get_r = true, get_v = true) annotation(
  ...
  Modelica.Mechanics.Translational.Components.SpringDamper springDamper(c = 35000, s_rel0 = 0, d = 2200) annotation(
    Placement(transformation(origin = {54, 52}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Mechanics.Translational.Components.IdealGearR2T idealGearR2T(ratio = 50) annotation(
    Placement(transformation(origin = {82, 71}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
  Modelica.Mechanics.Rotational.Components.Inertia inertia(J = 0.05) annotation(
  ...
  Modelica.Mechanics.MultiBody.Forces.WorldForce force1 annotation(
    Placement(transformation(origin = {-53, -104}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Sources.Sine sine1[3](amplitude = {0, 1000, 0}, f = {0, 5, 0}) annotation(
    Placement(transformation(origin = {-91, -105}, extent = {{-10, -10}, {10, 10}})));
equation
  ...
  connect(SprungMassCase3.frame_a, body.frame_a) annotation(
  ...
  connect(UnsprungMassCase3.frame_a, body1.frame_a) annotation(
  ...
  connect(force1.frame_b, body1.frame_a) annotation(
    Line(points = {{-43, -104}, {-43, -26}, {-26, -26}}, color = {95, 95, 95}));
  ...
  connect(sine1.y, force1.force) annotation(
    Line(points = {{-80, -104}, {-64, -104}}, color = {0, 0, 127}, thickness = 0.5));
  annotation(
